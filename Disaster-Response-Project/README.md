...
## Installation
Install Python 3 along with numpy, pandas, sqlalchemy, re, NLTK, pickle, Sklearn, plotly and flask libraries.
...
Many thanks to Figure-8 for making this available to Udacity for training purposes. Special thanks to Udacity for the training. Feel free to utilize the contents of this while citing Me,Udacity, and Figure-8 accordingly.
